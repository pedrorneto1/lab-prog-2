...
class JogoTest {
	...
	@Test
	void testVitoriaJ1Quadrada() throws Exception {
		List<Peca> mao1 = List.of(new Peca(4, 3), new Peca(4, 6), new Peca(6, 6));
		List<Peca> mao2 = List.of(new Peca(3, 5), new Peca(5, 6), new Peca(2, 1));
		...
		assertTrue(j.isFinalizado());
		assertEquals("J1", j.getVencedor());
		assertEquals(true, j.verificaCarroca());
		assertEquals(true, j.verificaLaeLo());
	}
	
	@Test
	void testVitoriaJ1LaeLo() throws Exception {
		List<Peca> mao1 = List.of(new Peca(2, 5), new Peca(2, 4));
		List<Peca> mao2 = List.of(new Peca(5, 4), new Peca(3, 1));
	...
	@Test
	void testVitoriaJ1Carroca() throws Exception {
		List<Peca> mao1 = List.of(new Peca(1, 3), new Peca(3, 3));
		List<Peca> mao2 = List.of(new Peca(1, 5), new Peca(4, 6));
