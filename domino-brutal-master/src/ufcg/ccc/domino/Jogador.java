...
public class Jogador {
	...
	/**
	 * Realiza a soma dos números nas peças da mão do jogador.
	 * 
	 * @return Soma dos números nas peças da mão.
	 */
	public int getSomaNumerosMao() {
		int somaNumerosPecas = 0;
		for (Peca peca : mao) {
			somaNumerosPecas += peca.getNumDireito();
			somaNumerosPecas += peca.getNumEsquerdo();
		}
		return somaNumerosPecas;
	}
}
